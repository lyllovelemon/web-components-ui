...
const componentMenus = [
  ...
  { title: 'Icon 图标', path: '/components/wcu-icon' },
  { title: 'Button 按钮', path: '/components/wcu-button' },
  { title: 'Loading 加载', path: '/components/wcu-loading' },
  { title: 'Tag 标签', path: '/components/wcu-tag' },
];
